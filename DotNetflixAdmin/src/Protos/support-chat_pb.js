...
goog.exportSymbol('proto.HistoryResponse', null, global);
 ...
 * @constructor
 */
proto.HistoryResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.HistoryResponse.repeatedFields_, null);
};
goog.inherits(proto.HistoryResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.HistoryResponse.displayName = 'proto.HistoryResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.HistoryResponse.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.HistoryResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.HistoryResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.HistoryResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.HistoryResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    messagesList: jspb.Message.toObjectList(msg.getMessagesList(),
    proto.MessageResponse.toObject, includeInstance)
  };
 ...
 */
proto.HistoryResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.HistoryResponse;
  return proto.HistoryResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.HistoryResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.HistoryResponse}
 */
proto.HistoryResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto.MessageResponse;
      reader.readMessage(value,proto.MessageResponse.deserializeBinaryFromReader);
 ...
 * @return {!Uint8Array}
 */
proto.HistoryResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.HistoryResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.HistoryResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.HistoryResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.MessageResponse.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Array<!proto.MessageResponse>}
 */
proto.HistoryResponse.prototype.getMessagesList = function() {
  return /** @type{!Array<!proto.MessageResponse>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.MessageResponse, 1));
};


/**
 * @param {!Array<!proto.MessageResponse>} value
 * @return {!proto.HistoryResponse} returns this
*/
proto.HistoryResponse.prototype.setMessagesList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.MessageResponse=} opt_value
 * @param {number=} opt_index
 * @return {!proto.MessageResponse}
 */
proto.HistoryResponse.prototype.addMessages = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.MessageResponse, opt_index);
};
 ...
 * @return {!proto.HistoryResponse} returns this
 */
proto.HistoryResponse.prototype.clearMessagesList = function() {
