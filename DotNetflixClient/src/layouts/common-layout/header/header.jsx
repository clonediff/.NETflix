...
const Header = () => {
    ...
    const submit = (values) => {
        ...
        if (Object.keys(keyValuePairs).length !== 0 || actors.length !== 0 || genres.length !== 0) {
            ...
            actors.forEach(actor => searchParams.append('actors', actor))
            navigate({
                pathname: '/search',
