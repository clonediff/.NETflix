    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CountryMovieInfo", x => new { x.CountryId, x.MovieInfoId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GenreMovieInfo", x => new { x.MovieInfoId, x.GenreId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PersonProffessionInMovie", x => new { x.MovieInfoId, x.PersonId, x.ProfessionId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PersonProffessionInMovie_Professions_ProfessionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SeasonsInfos", x => x.Id);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PersonProffessionInMovie_ProfessionId",
                table: "PersonProffessionInMovie",
                column: "ProfessionId");
