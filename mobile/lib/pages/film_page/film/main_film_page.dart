          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                MainInfo(film: film),
                MoreInfo(film: film),
                Persons(persons: film.professions.entries
                    .where((element) => element.key == 'Актеры')
                    .map((e) => e.value)
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              //Todo получать флаги через switch
              Flag.fromCode(
                FlagsCode.JP,
                height: 12,
                width: 18,
              ...
              //Todo сделать ListView по всем странам
              Flexible(
                child: Text(
                  '${film.countries.first.name}, ${film.year} г.',
          ...
          Row(
            children: [
              ...
              Flexible(
                child: Text('${film.seasonsInfo.length > 1 ? 'Cезонов: ${film.seasonsInfo.last.number} по' : ''} ${film.seasonsInfo.first.episodesCount} эп. по ~${film.movieLength} мин.',
                    style: DotNetflixTextStyles.mainTextStyle),
              )
            ],
          ),
          Row(
            children: [
              ...
              Flexible(
                  child: Text(
                      '${film.type}, ${film.year < DateTime.now().year ? 'вышел' : 'выходит'}.',
                      style: DotNetflixTextStyles.mainTextStyle
                  )
              )
            ],
            ...
            children: [
              ...
              Material(
                ...
                child: InkWell(
                  ...
                  onTap: () {
                    //todo удалить таймер
                    Timer(const Duration(seconds: 1),() => goToSelectedPage(context, title == 'Актеры' ? 1 : 2));
                  },
                ),
              )
            ],
        ...
        SizedBox(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              //todo если ссылка пустая, то нужно создать фото по умолчанию
              var image = /*photo.isEmpty ?  Image(image: ,) : */
               Image.network(photo, height: 160, width: 120, fit: BoxFit.cover);
